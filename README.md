...
The wxMaxima tutorial2x.wxmx and exported tutorial2x.html files present the derivation of non-linearized differential equations of motion utilized in the tutorial2x.py script for the idealized double pendulum system.
